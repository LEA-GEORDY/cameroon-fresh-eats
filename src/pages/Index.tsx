  ...
  const testimonials = [
    {
      ...
      rating: 5,
      avatar: "/src/assets/testimonials/african-woman-1.jpg",
    },
    {
      name: "Jean-Paul M.",
      location: "Yaounde",
      ...
      rating: 5,
      avatar: "/src/assets/testimonials/african-man-1.jpg",
    },
    {
      name: "Aminata D.",
      location: "Bafoussam",
      ...
      rating: 5,
      avatar: "/src/assets/testimonials/african-woman-2.jpg",
    },
    {
      name: "Pierre E.",
      location: "Kribi",
      text: "Le Bissap est exactement comme celui de ma grand-mere. Un vrai delice nostalgique !",
      rating: 5,
      avatar: "/src/assets/testimonials/african-man-2.jpg",
    },
    {
      name: "Fatou N.",
      location: "Garoua",
      text: "Commander est simple et la qualite est toujours au rendez-vous. Mes enfants adorent !",
      rating: 5,
      avatar: "/src/assets/testimonials/african-woman-3.jpg",
    },
    {
      name: "Samuel T.",
      location: "Limbe",
      text: "Les shots au gingembre m'ont change la vie. Plus d'energie chaque matin !",
      rating: 5,
      avatar: "/src/assets/testimonials/african-man-3.jpg",
    },
    {
      name: "Grace O.",
      location: "Bamenda",
      text: "Le service est impeccable et les produits sont 100% naturels. Je suis cliente fidele !",
      rating: 5,
      avatar: "/src/assets/testimonials/african-woman-4.jpg",
    },
  ];
